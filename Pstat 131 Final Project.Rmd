...
YTrain = training_set$drafted
XTrain = training_set %>% select(-drafted) %>% scale(center = TRUE, scale = TRUE)
# YTest is the true labels for drafted on the test set, Xtest is the design matrix
YTest = training_set$drafted
XTest = training_set %>% select(-drafted) %>% scale(center = TRUE, scale = TRUE)


```

Fit an initial knn model.
