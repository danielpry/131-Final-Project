...
```{r}
conference <- as.data.frame(dummy.code(training_set$conference))
num_seasons <- as.data.frame(dummy.code(training_set$num_seasons))

conference_t <- as.data.frame(dummy.code(test_set$conference))
num_seasons_t <- as.data.frame(dummy.code(test_set$num_seasons))


trn_st <- cbind(training_set, conference, num_seasons)
